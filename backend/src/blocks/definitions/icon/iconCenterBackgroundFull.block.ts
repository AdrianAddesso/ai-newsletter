...
export class IconCenterBackgroundFullBlock extends BlockDefinition {
  ...
  readonly editFields = [
    { key: 'iconName', label: 'Nombre del Ã­cono (Material)', type: 'text' as const, placeholder: 'description', required: true, defaultValue: 'description' },
    { key: 'iconAsset', label: 'Ãcono', type: 'image-asset' as const, assetTypes: ['ICON', 'IMAGE'] as const },
