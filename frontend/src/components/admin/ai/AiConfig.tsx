    ...
    // Promise chain keeps setState inside callbacks, satisfying react-hooks/set-state-in-effect
    useEffect(() => {
        getAiConfigs()
        .then((data) => setConfigs(data))
        .catch(() => setError("No se pudieron cargar las configuraciones de IA."))
