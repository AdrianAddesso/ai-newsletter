...
// ./AssetsAddModal may be missing in some setups; provide lightweight local types
// and a stub component to avoid build-time import errors. The real modal can
// be restored by re-adding the original file and removing these local defs.
...
function AssetsAddModal(_props: AssetsAddModalProps) {
  // Intentional no-op stub to satisfy imports when the original file is absent.
  return null;
}
...
const INITIAL_ASSETS: Asset[] = [
  {
    id: "1",
    name: "Logo principal",
    description: "Logo principal en fondo claro",
    created_at: "2024-02-01",
    type: "IMAGE",
    bucket: "brand-assets",
    file_name: "primary_logo_white.png",
    extension: "png",
    size_bytes: 45200,
    from_brand: true,
  },
